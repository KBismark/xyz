...
return [{"row":{node:_a,$events:{},evc:{}},2:{node:_b,$events:{click:function (e, This) { UI.getPublicData(UI.getParentInstance(This)).select(getInstance(This)); },},evc:{click:$_b,}},3:{node:_c,$events:{click:function (e, This) { UI.getPublicData(UI.getParentInstance(This)).remove(getInstance(This)); },},evc:{click:$_c,}},}]},{'0':function(args,state){return (state.id)},'1':function(args,state){return (UI.CreateDynamicNode(function (state) { return state.label }, ["label"]))},length:2},
